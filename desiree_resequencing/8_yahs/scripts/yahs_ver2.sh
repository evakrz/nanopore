...
#java env installation, ze narejen
...
asm=/scratch/evakrzisnik/desiree_resequencing/3_assembly/outputs/16/16.asm.hap1.p_ctg.fa
asm_name=$(basename -s .fa $asm)
out_dir=$out_base/$asm_name
bam=/scratch/evakrzisnik/desiree_resequencing/6_omni-c_mapping/output/asm_16_hap1/mapped.PT.bam
...
#rm /scratch/evakrzisnik/desiree_resequencing/6_omni-c_mapping/output/asm_16_hap1/mapped.bam
