...
asm=/scratch/evakrzisnik/desiree_resequencing/3_assembly/outputs/16/16.asm.hap3.p_ctg.fa
asm_name=$(basename -s .fa $asm)
out_dir=$out_base/$asm_name
bam=/scratch/evakrzisnik/desiree_resequencing/6_omni-c_mapping/output/asm_16_hap3/mapped.PT.bam
